...
public class TransferServiceTest {
    ...
    public void testTransferMoneySuccessful() throws InsufficientBalanceException, UserNotFoundException,
        ...
        Long senderId = 1L;
        Long recipientId = 2L;
        double senderBalance = 200.0;
        double recipientBalance = 100.0;
        double amount = 50.0;
        User sender = new User();
        sender.setId(senderId);
        BankAccount senderAccount = new BankAccount();
        ...
        transferService.transferMoney(senderId, recipientId, amount);
        assertEquals(senderBalance - amount, sender.getBankAccount().getBalance(), 0);
        assertEquals(recipientBalance + amount, recipient.getBankAccount().getBalance(), 0);
    }
}
